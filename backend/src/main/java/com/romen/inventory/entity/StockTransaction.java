...
@Table(name = "stock_transactions",
        indexes = {
                @Index(name = "idx_transactions_medication", columnList = "medication_id"),
                @Index(name = "idx_transactions_batch", columnList = "batch_id"),
...
public class StockTransaction {
    ...
    public enum TransactionType {
        ...
        QUARANTINE         // Moved to quarantine (expired/recalled)
    }
