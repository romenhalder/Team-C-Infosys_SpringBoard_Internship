...
public interface AlertRepository extends JpaRepository<Alert, Long> {
    ...
    List<Alert> findByMedicationIdOrderByCreatedAtDesc(Long medicationId);
    ...
    boolean existsByMedicationIdAndAlertTypeAndIsResolvedFalse(Long medicationId, Alert.AlertType type);
