...
public interface StockTransactionRepository extends JpaRepository<StockTransaction, Long> {
    ...
    List<StockTransaction> findByMedicationIdOrderByTransactionDateDesc(Long medicationId);
    ...
    @Query("SELECT st FROM StockTransaction st WHERE st.medication.id = :medicationId AND st.transactionDate BETWEEN :startDate AND :endDate ORDER BY st.transactionDate DESC")
    List<StockTransaction> findByMedicationAndDateRange(@Param("medicationId") Long medicationId,
