...
public class InventoryController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'EMPLOYEE')")
    public ResponseEntity<InventoryResponse> getInventoryByMedication(@PathVariable Long productId) {
        InventoryResponse inventory = inventoryService.getInventoryByMedication(productId);
        return ResponseEntity.ok(inventory);
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'EMPLOYEE')")
    public ResponseEntity<List<StockTransactionResponse>> getTransactionsByMedication(@PathVariable Long productId) {
        List<StockTransactionResponse> transactions = inventoryService.getTransactionsByMedication(productId);
        return ResponseEntity.ok(transactions);
    }
