...
public class AlertController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'EMPLOYEE')")
    public ResponseEntity<List<AlertResponse>> getAlertsByMedication(@PathVariable Long productId) {
        List<AlertResponse> alerts = alertService.getAlertsByMedication(productId);
        return ResponseEntity.ok(alerts);
    }
